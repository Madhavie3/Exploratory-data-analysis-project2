...
subsetEMI <- EMI[(EMI$fips=="24510"|EMI$fips=="06037") & EMI$type=="ON-ROAD",  ]

aggregatedTotalByYearAndFips <- aggregate(Emissions ~ year + fips, subsetEMI, sum)
